...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("You look at your speedometer and you are going "
        + Car.getCurrentSpeed() + "mph. Would you like to change your speed?");
    ...
    if (choice.equals("yes")) {
      ...
      System.out.println("OK. You are now going " + Car.getCurrentSpeed()
          + "mph. Now lets see if you evade the cops..." + "\nLoading...");

      // Determines if user evades
      if (Car.getCurrentSpeed() > 75) {
        System.out.println(
            "Sorry... You were going too fast and were pulled" + " over.");
      } else if (Car.getCurrentSpeed() < 65) {
        System.out.println(
    ...
    System.out
        .println("Now enter an integer between 0 and " + (word.length() - 1));
    int charPlace = scan.nextInt();
    scan.nextLine();
    System.out.println("Loading...");
